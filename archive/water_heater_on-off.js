...
const FRAME_RATE = 25;      // changes heating speed too :(
...
function automated_temperature_control() {
  // This will keep the temperature automatically at 40 degrees!
  difference = reference - temperature
  if(difference > 0.195) {
    heaterOn()
  } 
  else
