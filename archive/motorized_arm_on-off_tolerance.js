// https://editor.p5js.org/mkreier/sketches/G-4_sH873
CANVAS_SIZE = 700;
ARM_WIDTH = 10;
...
// Input parameters: arm_angle      - measured by the system
//                                  - set by you
// Output parameter: arm_torque     - control of the motor

let SETPOINT = 45;
let MOTOR_TORQUE = 1180;
let TOLERANCE = 5;
...
function draw() {
  ...
  else if(arm_angle < SETPOINT + TOLERANCE) {
    arm_torque = 0.8 * MOTOR_TORQUE
  }
